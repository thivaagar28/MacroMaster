          ...
          <Flex w={'full'} p={2} flexDir={'column'}>
            ...
            <Flex flex={1} px={5}>
              <SimpleGrid w={'full'} columns={4} spacingX='5' spacingY='5px'>
                <MacroStat name='Consumer Price Index (CPI)' perc={data.cpi} trend={trend_check(data.cpi)} />
                <MacroStat name='Inflation Growth Rate' perc={data.inf} trend={trend_check(data.inf)} /> 
                <MacroStat name='Goverment Reserves (Billions)' perc={data.ipi} trend={trend_check(data.cpi)} />
                <MacroStat name='Industrial Production Index' perc={data.ipi} trend={trend_check(data.ipi)} />
                <MacroStat name='Long Term Interest Rate' perc={data.lt_ir} trend={trend_check(data.lt_ir)} />
                <MacroStat name='Short Term Interest Rate' perc={data.st_ir} trend={trend_check(data.st_ir)} />
                <MacroStat name='Gross Domestic Product (GDP)' perc={data.gdpt} trend={trend_check(data.gdpt)} />
                <MacroStat name='Unemployment Rate'  perc={data.ur} trend={trend_check(data.ur)}/>
                <MacroStat name='Producer Price Index (PPI)'  perc={data.ppi} trend={trend_check(data.ppi)}/>
                <MacroStat name='Wholesale & Retail Trade'  perc={data.wrt} trend={trend_check(data.wrt)}/>
                <MacroStat name='Business Cycle Indicators (BCI)' perc={data.bcli} trend={trend_check(data.bcli)}/>
